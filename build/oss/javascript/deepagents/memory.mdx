...
- [Skills](/oss/javascript/deepagents/skills) can be passed via `skills=` for reusable capabilities loaded on demand
...
| **Information type** | What kind of information is it? | [Episodic](#episodic-memory) (past experiences), [procedural](/oss/javascript/concepts/memory#procedural-memory) (instructions and [skills](/oss/javascript/deepagents/skills)), or [semantic](/oss/javascript/concepts/memory#semantic-memory) (facts) |
