...
| [**Information type**](#memory-patterns) | What kind of information is it? | [Semantic](/oss/python/concepts/memory#semantic-memory) (facts), [episodic](/oss/python/concepts/memory#episodic-memory) (experiences), or [procedural](/oss/python/concepts/memory#procedural-memory) (instructions) |
