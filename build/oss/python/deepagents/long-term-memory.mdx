...
Semantic memories can be stored as a single continuously updated [profile](/oss/python/concepts/memory#profile) or as a [collection](/oss/python/concepts/memory#collection) of individual documents, each with different tradeoffs. For a deeper conceptual overview, see the [memory concepts guide](/oss/python/concepts/memory).
